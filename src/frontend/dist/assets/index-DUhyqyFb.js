const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Accueil-D2vYxdfW.js","assets/button-CdhFZ59Z.js","assets/createLucideIcon-j6fs3MjL.js","assets/bus-DPlZB0_1.js","assets/map-pin-xx-aFEzN.js","assets/smartphone-BE8FrKkT.js","assets/circle-check-D2eFc3Gy.js","assets/Inscription-COGRWePN.js","assets/card-MZW6CVrX.js","assets/input-CbtPJOZt.js","assets/label-Djb-Jo-w.js","assets/index-BFiPEdCa.js","assets/chevron-left-CGIb9UqK.js","assets/chevron-right-Bs2Jjrmm.js","assets/refresh-cw-oKlGoEO4.js","assets/eye-Xkcfa9oB.js","assets/Connexion-CHQ5aNLa.js","assets/OTP-Bfof972s.js","assets/shield-check-J0dyOM7c.js","assets/TableauDeBord-Dq_bq5Xz.js","assets/Layout-DDt5v_fd.js","assets/dialog-DRnWDU1w.js","assets/index-BE_z24Hx.js","assets/index-CDC68prk.js","assets/credit-card-ys6N7uAu.js","assets/Bus-QzryHV_K.js","assets/clock-LzN1NZmX.js","assets/LigneDetail-BEKEC8o7.js","assets/Historique-DvHoejPT.js","assets/separator-BWVUzkOS.js","assets/Recharge-rI9lf3Rd.js","assets/zap-QSmeDqVB.js","assets/Profil-Ct57BhBH.js"])))=>i.map(i=>d[i]);
...
const mockUtilisateurs = [
  {
    ...
    // 1 250,00 DZD
    estVerifie: true,
    dateInscription: Date.now() - 864e5 * 90
  },
  {
    id: "usr_002",
    ...
    // 450,00 DZD
    estVerifie: true,
    dateInscription: Date.now() - 864e5 * 45
  },
  {
    id: "usr_003",
    ...
    // 85,00 DZD
    estVerifie: false,
    dateInscription: Date.now() - 864e5 * 10
  }
];
const mockLignes = [
  // Naâma
...
const mockNotifications = [
  {
    ...
    message: "Votre solde a été rechargé de 500,00 DZD via BaridiMob. Nouveau solde: 1 250,00 DZD.",
    timestamp: Date.now() - 864e5 * 2,
    lue: false
  },
  {
    ...
    message: "La ligne L-102 arrivera à la station Marché couvert dans 5 minutes.",
  ...
  },
  {
    ...
    message: "Trajet ligne L-088: 90,00 DZD déduits. Solde restant: 1 160,00 DZD.",
    timestamp: Date.now() - 864e5 * 1,
    lue: true
  },
  {
    ...
    utilisateurId: "usr_001",
    typeNotif: "promotion",
    message: "Offre spéciale: Rechargez 1 000 DZD et obtenez 50 DZD de bonus! Valable jusqu'au 30 avril.",
    timestamp: Date.now() - 864e5 * 3,
    lue: true
  },
  {
    ...
    message: "La ligne L-215 est retardée de 10 minutes en raison d'un incident de circulation.",
    timestamp: Date.now() - 36e5 * 5,
    lue: true
  }
];
function formatSolde(centimes) {
  return (centimes / 100).toLocaleString("fr-DZ", {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  });
}
function getLignesByRegion(region) {
...
function AuthProvider({ children }) {
  const [utilisateur, setUtilisateur] = reactExports.useState(null);
  ...
  const connexion = reactExports.useCallback(
    async (telephone, _motDePasse) => {
  ...
  const inscription = reactExports.useCallback(
    async (data) => {
      ...
      const nouvelUtilisateur = {
        ...
        numeroCarte: `BP-${(/* @__PURE__ */ new Date()).getFullYear()}-${String(mockUtilisateurs.length + 1).padStart(3, "0")}`,
        solde: 0,
        estVerifie: false,
        // nécessite OTP
  ...
  const verifierOtp = reactExports.useCallback((telephone) => {
    const index2 = mockUtilisateurs.findIndex((u) => u.telephone === telephone);
    if (index2 !== -1) {
      mockUtilisateurs[index2] = {
        ...mockUtilisateurs[index2],
        estVerifie: true
      };
    }
  }, []);
  const deconnexion = reactExports.useCallback(() => {
    setUtilisateur(null);
    localStorage.removeItem(STORAGE_KEY);
  }, []);
  const mettreAJourSolde = reactExports.useCallback((nouveauSolde) => {
    setUtilisateur((prev) => {
      if (!prev) return null;
...
const Accueil = reactExports.lazy(() => __vitePreload(() => import("./Accueil-D2vYxdfW.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
const Inscription = reactExports.lazy(() => __vitePreload(() => import("./Inscription-COGRWePN.js"), true ? __vite__mapDeps([7,1,2,8,9,10,11,12,13,14,15]) : void 0));
const Connexion = reactExports.lazy(() => __vitePreload(() => import("./Connexion-CHQ5aNLa.js"), true ? __vite__mapDeps([16,1,2,8,9,10,11,3,15]) : void 0));
const OTP = reactExports.lazy(() => __vitePreload(() => import("./OTP-Bfof972s.js"), true ? __vite__mapDeps([17,1,2,8,12,18]) : void 0));
const TableauDeBord = reactExports.lazy(() => __vitePreload(() => import("./TableauDeBord-Dq_bq5Xz.js"), true ? __vite__mapDeps([19,20,2,12,3,1,21,22,23,24,14]) : void 0));
const Bus = reactExports.lazy(() => __vitePreload(() => import("./Bus-QzryHV_K.js"), true ? __vite__mapDeps([25,20,2,12,3,8,9,23,4,26,13]) : void 0));
const LigneDetail = reactExports.lazy(() => __vitePreload(() => import("./LigneDetail-BEKEC8o7.js"), true ? __vite__mapDeps([27,20,2,12,3,1,8,23,4,26,6]) : void 0));
const Historique = reactExports.lazy(() => __vitePreload(() => import("./Historique-DvHoejPT.js"), true ? __vite__mapDeps([28,20,2,12,3,1,21,22,29,11]) : void 0));
const Recharge = reactExports.lazy(() => __vitePreload(() => import("./Recharge-rI9lf3Rd.js"), true ? __vite__mapDeps([30,20,2,12,3,1,9,10,11,24,6,5,14,31]) : void 0));
const Profil = reactExports.lazy(() => __vitePreload(() => import("./Profil-Ct57BhBH.js"), true ? __vite__mapDeps([32,20,2,12,3,22,1,9,10,11,29,18,24,13,31]) : void 0));
function PageChargement() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-dvh bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 border-4 border-primary/20 border-t-primary rounded-full animate-spin" }),
...
function RequiertAuth({ children }) {
  const { estConnecte, chargement } = useAuth();
  if (chargement) return /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {});
  if (!estConnecte) return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/connexion" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
}
function RequiertNonAuth({ children }) {
  const { estConnecte, chargement } = useAuth();
  if (chargement) return /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {});
  if (estConnecte) return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/tableau-de-bord" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
}
...
const accueilRoute = createRoute({
  ...
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Accueil, {}) })
});
const inscriptionRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/inscription",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertNonAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Inscription, {}) }) })
});
const connexionRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/connexion",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertNonAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Connexion, {}) }) })
});
const otpRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/otp",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(OTP, {}) })
});
const tableauDeBordRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/tableau-de-bord",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableauDeBord, {}) }) })
});
const busRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/bus",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bus, {}) }) })
});
const ligneDetailRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/bus/$ligneId",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(LigneDetail, {}) }) })
});
const historiqueRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/historique",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Historique, {}) }) })
});
const rechargeRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/recharge",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Recharge, {}) }) })
});
const profilRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/profil",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(RequiertAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageChargement, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Profil, {}) }) })
});
...
export {
  ...
  useNavigate as a,
  ue as b,
  mockTransactions as c,
  useParams as d,
  mockBus as e,
  formatSolde as f,
  getLignesByRegion as g,
  getTransactionsByUser as h,
  React$5 as i,
  jsxRuntimeExports as j,
  reactDomExports as k,
  ReactDOM$2 as l,
  mockLignes as m,
  mockNotifications as n,
  useRouterState as o,
  reactExports as r,
  useAuth as u
};
