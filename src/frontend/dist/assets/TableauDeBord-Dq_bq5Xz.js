import { j as jsxRuntimeExports, r as reactExports, R as React, u as useAuth, a as useNavigate, m as mockLignes, c as mockTransactions, f as formatSolde } from "./index-DUhyqyFb.js";
import { u as useNotifications, L as Layout, H as History, B as Badge } from "./Layout-DDt5v_fd.js";
import { B as Button } from "./button-CdhFZ59Z.js";
import { A as ArrowUpRight, D as Dialog, a as DialogContent, X } from "./dialog-DRnWDU1w.js";
...
function getImageSettings(cells, size, margin, imageSettings) {
  ...
  const w = (imageSettings.width || defaultSize) * scale2;
  const h = (imageSettings.height || defaultSize) * scale2;
  const x = imageSettings.x == null ? cells.length / 2 - w / 2 : imageSettings.x * scale2;
  const y = imageSettings.y == null ? cells.length / 2 - h / 2 : imageSettings.y * scale2;
...
function horodatageRelatif(timestamp) {
  const diff = Date.now() - timestamp;
  const minutes = Math.floor(diff / 6e4);
  const heures = Math.floor(diff / 36e5);
  const jours = Math.floor(diff / 864e5);
    ...
    motion.button,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-snug line-clamp-2", children: notif.message }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: horodatageRelatif(notif.timestamp) }),
            !notif.lue && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary inline-block" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
...
function TableauDeBord() {
  ...
  const [chargement, setChargement] = reactExports.useState(true);
  const [qrOuvert, setQrOuvert] = reactExports.useState(false);
  const [qrTimestamp, setQrTimestamp] = reactExports.useState(Date.now());
  ...
  reactExports.useEffect(() => {
    intervalRef.current = setInterval(() => setQrTimestamp(Date.now()), 6e4);
    return () => {
      if (intervalRef.current) clearInterval(intervalRef.current);
    };
  }, []);
  const rafraichirQr = reactExports.useCallback(() => setQrTimestamp(Date.now()), []);
  ...
  const lignesRegion = reactExports.useMemo(
    () => mockLignes.filter((l) => l.region === regionActive).slice(0, 3),
    [regionActive]
  );
  const transactions = reactExports.useMemo(
    () => mockTransactions.filter((t) => t.utilisateurId === (utilisateur == null ? void 0 : utilisateur.id)).slice(0, 3),
    [utilisateur]
  );
  const dernieresNotifs = reactExports.useMemo(
    () => notifications.slice(0, 3),
    [notifications]
  );
  const nonLues = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { titre: "BusPass", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-primary-foreground px-4 pt-3 pb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-sm", children: "Bonjour," }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-display font-bold leading-tight", children: [
            prenom,
            " 👋"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-1 opacity-65", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono tracking-wider", children: utilisateur.numeroCarte })
          ] })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 -mt-6 space-y-4 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[1fr_auto]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary p-4 rounded-tl-2xl rounded-bl-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-[11px] font-semibold uppercase tracking-wider mb-1", children: "Solde actuel" }),
              chargement ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-36 bg-primary-foreground/20 rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-end gap-1",
                  "data-ocid": "dashboard.balance_amount",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-display font-bold text-primary-foreground balance-pulse", children: soldeFormate }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70 text-sm font-semibold mb-0.5", children: "DZD" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-5 h-5 text-accent-foreground" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-foreground font-bold text-xs text-center leading-tight", children: "Recharger" })
                ]
              }
            )
          ] })
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground", children: "Mon QR Code" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Présentez au receveur pour payer" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomIn, { className: "w-4 h-4 text-muted-foreground" })
                  }
                )
              ] })
            ] }),
            chargement ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-36 h-36 rounded-xl" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bus, { className: "w-5 h-5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground leading-tight", children: "Lignes" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Voir les bus" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-accent/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "w-5 h-5 text-accent" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground leading-tight", children: "Historique" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Mes trajets" })
                  ] })
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground", children: "Lignes disponibles" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-2 mb-3 scrollbar-hide", children: REGIONS_LIST.map((region) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                className: cn(
                  ...
                  regionActive === region ? "bg-primary text-primary-foreground border-primary" : "bg-background text-muted-foreground border-border hover:border-primary/40"
                ),
            ...
            chargement ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-xl" }, n)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: lignesRegion.map((ligne, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: () => navigate({
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bus, { className: "w-4.5 h-4.5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 text-left", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: ligne.numero }),
                      ligne.statut === "en_service" && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-[10px] px-1.5 py-0 bg-primary/15 text-primary border-0 shrink-0 h-4", children: "En service" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: ligne.nom })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-accent", children: [
                      ligne.tarif,
                      " DZD"
                    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground", children: "Derniers mouvements" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
            ...
            chargement ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 rounded-xl" }, n)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: transactions.map((t, i) => {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: isRecharge ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-4 h-4 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "w-4 h-4 text-destructive" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: isRecharge ? "Recharge BaridiMob" : "Trajet payé" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: new Date(t.timestamp).toLocaleDateString("fr-DZ") })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground", children: "Notifications" }),
                nonLues > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-[10px] px-1.5 py-0 bg-accent text-accent-foreground border-0 h-4", children: nonLues })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
            ...
            chargement ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mt-3", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-2", children: [
            ...
            ] }, n)) }) : dernieresNotifs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Aucune notification pour le moment" })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: dernieresNotifs.map((notif, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ItemNotification,
              {
                notif,
                index: i,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: qrOuvert && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: qrOuvert, onOpenChange: setQrOuvert, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      DialogContent,
      {
        className: "max-w-sm mx-auto p-0 rounded-2xl overflow-hidden border-0 shadow-2xl",
        "data-ocid": "dashboard.qr_dialog",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary flex flex-col items-center gap-5 p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-primary-foreground font-display font-bold text-lg leading-tight", children: "QR Code de paiement" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/65 text-xs font-mono mt-0.5", children: utilisateur.numeroCarte })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5 text-primary-foreground" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-sm", children: "Solde disponible" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground font-display font-bold text-2xl mt-0.5", children: [
              soldeFormate,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/60 text-base", children: "DZD" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-primary-foreground/55 text-xs", children: [
